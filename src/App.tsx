...
export default function App() {
  ...
  // Refresh the build info (mod count, versions) and the server's online
  // status every 20s, so an already-open launcher picks up changes made
  // on the server (new mods added/removed, players joining) without the
  // player having to restart it.
  useEffect(() => {
    const poll = async () => {
